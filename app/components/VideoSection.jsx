  ...
  return (
    <div className="relative">
      <div className="flex justify-center pt-10 ">
        <h2 className="text-3xl font-bold">A word from our Director</h2>
      </div>
      <div className="relative flex flex-col justify-center items-center pt-10 z-20 sm:px-10 lg:px-1 lg:flex-row ">
        <Image
          src="/curve1.svg"
          className="absolute bottom-40 left-5 h-[80%] w-1/3 z-50 hidden sm:hidden lg:block"
          width={200}
          height={200}
          alt="Curve 1"
        />
        <Image
          src="/curve2.svg"
          className="absolute -bottom-20 right-20 h-3/4 w-1/2 z-20 hidden sm:hidden lg:block"
          width={300}
          height={300}
          alt="Curve 2"
        />
