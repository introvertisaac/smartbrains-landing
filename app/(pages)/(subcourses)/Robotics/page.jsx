...
const HomePage = () => {
  const hero = {
    ...
    description:
    'Engaging and interactive lessons designed specifically for kids to learn robotics concepts with ease.',
    },
    {
    title: 'Hands-on Projects',
    description:
    'Practice what you learn by building and programming your own robots to perform various tasks and challenges.',
    },
    {
    ...
    description:
    'Explore your creativity and problem-solving skills as you design and innovate with robotics technology.',
    },
    ],
    extraDescription:
    'Join us on this thrilling journey to explore the world of robotics and unleash your potential as a future engineer or scientist!',
    ctaButton: {
    label: 'Get Started',
    },
    downloadButton: {
