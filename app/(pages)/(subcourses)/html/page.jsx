...
const HomePage = () => {
  const hero = {
    ...
    description:
    'Welcome to our HTML coding course for kids! Unleash your creativity and build the web of tomorrow. With HTML, you can design and create your own websites from scratch. Get ready to dive into the exciting world of coding!',
    features: [
    {
    title: 'Interactive Lessons',
    description:
    'Engaging and interactive lessons designed specifically for kids to learn HTML with ease.',
    },
    {
    title: 'Hands-on Projects',
    description:
    'Practice what you learn with fun projects that unleash your creativity.',
    },
    {
    ...
    description:
    'Develop valuable skills that can set you up for success in the digital age.',
    },
    ],
    extraDescription:
    'Join us on this exciting journey to unlock the power of HTML and unleash your potential as a future web developer!',
    ctaButton: {
    label: 'Get Started',
    },
    downloadButton: {
